...
if( is_file( dirname( $wgMediaWikiFarmCodeDir ) . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'DefaultSettings.php' ) ) exit;
...
require MediaWikiFarm::load( 'load.php' );
